...
#   created flanger effect with settled the parameter
...
# Flanger parameters
f0 = 2
W = 0.2   # sweep width W = 0 # for no effct
g = 0.5
min_delay = 0.02

# Create a buffer (delay line) for past values
buffer_MAX = int(min_delay * 2 * RATE)                        # Buffer length
...
for n in range(0, LEN):
    ...
    output_value = input_value + g * ((1-frac) * buffer[kr_prev] + frac * buffer[kr_next])
