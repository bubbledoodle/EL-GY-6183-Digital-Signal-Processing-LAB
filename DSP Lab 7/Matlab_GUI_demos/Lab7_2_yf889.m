function sec_order_recursive_filter
...
a1 = [2 2*cos(fc) 0];
[H1, om] = freqz(b1, a1);
line_handle1 = line(om/pi, abs(H1), 'linewidth', 2, 'color', 'black');
...
[H2, om] = freqz(b2, a2);
line_handle2 = line(om/pi, abs(H2), 'linewidth', 2, 'color', 'black');
...
a3 = [2 2*cos(0.5*pi) 0];
[H3, om] = freqz(b3, a3);
line_handle3 = line(om/pi, abs(H3), 'linewidth', 2, 'color', 'black');
...
slider_handle1 = uicontrol(f1, ...
    'Style', 'slider', ...
    'Min', 0.1, 'Max', pi, ...
    'Value', fc, ...
    'SliderStep', [0.02 0.05], ...
    'units', 'normalized', ...
    'Position', [0.12 0.47 0.35 0.2], ...
