...
N = 500;
n = 1:N;
x = sin(5*pi*n/N) + 0.7*randn(1, N);        % Input signal
...
subplot(2,1,2)
line_handle2 = line(om/pi, abs(H), 'linewidth', 2, 'color', 'black');
title( sprintf('Frequency Response. Cut-off frequency = %.3f (normalized)', fc) )
